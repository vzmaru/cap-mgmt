...
import com.tuc.capacity.web.ProjectController;
...
privileged aspect ProjectController_Roo_Controller {
    ...
    public String ProjectController.createForm(Model uiModel) {
        ...
        if (ProjectGroup.countProjectGroups() == 0) {
            dependencies.add(new String[] { "projectgroup", "projectgroups" });
        }
        if (TuLead.countTuLeads() == 0) {
            dependencies.add(new String[] { "tulead", "tuleads" });
        }
        if (ProjectType.countProjectTypes() == 0) {
            dependencies.add(new String[] { "projecttype", "projecttypes" });
        }
